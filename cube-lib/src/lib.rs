...
impl Cube {
    ...
    pub fn get_svg(&self) -> String {
        let cube: [[[i8; 3]; 3]; 9] = [
            self.left, self.front, self.up, self.down, self.right, self.back, self.front, self.up,
            self.right,
        ];
        make_svg(cube)
    }
...
mod tests {
    ...
    fn it_works_rot_front() {
        ...
        // [49, 50, 51],
        // [52, 53, 54]],
        assert_eq!(cube.left, [[19, 20, 46], [22, 23, 47], [25, 26, 48]]);
        // left: [
        // [19, 20, 21],
        // [22, 23, 24],
        // [25, 26, 27]],
        assert_eq!(cube.up, [[37, 38, 39], [40, 41, 42], [27, 24, 21]]);
        // up: [
        // [37, 38, 39],
        // [40, 41, 42],
        // [43, 44, 45]],
        assert_eq!(cube.right, [[43, 29, 30], [44, 32, 33], [45, 35, 36]]);
        // right: [
        // [28, 29, 30],
        // [31, 32, 33],
        // [34, 35, 36]],
        assert_eq!(cube.down, [[34, 31, 28], [49, 50, 51], [52, 53, 54]]);
    }
    #[test]
    fn it_works_rot_front_rev() {
        ...
        // [40, 41, 42],
        // [43, 44, 45]],
        assert_eq!(cube.left, [[19, 20, 45], [22, 23, 44], [25, 26, 43]]);
        // right: [
        // [28, 29, 30],
        // [31, 32, 33],
        // [34, 35, 36]],
        assert_eq!(cube.up, [[37, 38, 39], [40, 41, 42], [28, 31, 34]]);
        // down: [
        // [46, 47, 48],
        // [49, 50, 51],
        // [52, 53, 54]],
        assert_eq!(cube.right, [[48, 29, 30], [47, 32, 33], [46, 35, 36]]);
        // left: [
        // [19, 20, 21],
        // [22, 23, 24],
        // [25, 26, 27]],
        assert_eq!(cube.down, [[21, 24, 27], [49, 50, 51], [52, 53, 54]]);
    }
    ...
    fn it_works_rot_back() {
        ...
        // [40, 41, 42],
        // [43, 44, 45]],
        assert_eq!(cube.left, [[39, 20, 21], [38, 23, 24], [37, 26, 27]]);
        // right: [
        // [28, 29, 30],
        // [31, 32, 33],
        // [34, 35, 36]],
        assert_eq!(cube.up, [[30, 33, 36], [40, 41, 42], [43, 44, 45]]);
        // down: [
        // [46, 47, 48],
        // [49, 50, 51],
        // [52, 53, 54]],
        assert_eq!(cube.right, [[28, 29, 54], [31, 32, 53], [34, 35, 52]]);
        // left: [
        // [19, 20, 21],
        // [22, 23, 24],
        // [25, 26, 27]],
        assert_eq!(cube.down, [[46, 47, 48], [49, 50, 51], [19, 22, 25]]);
    }
    #[test]
    fn it_works_rot_back_rev() {
        ...
        // [49, 50, 51],
        // [52, 53, 54]],
        assert_eq!(cube.left, [[52, 20, 21], [53, 23, 24], [54, 26, 27]]);
        // left: [
        // [19, 20, 21],
        // [22, 23, 24],
        // [25, 26, 27]],
        assert_eq!(cube.up, [[25, 22, 19], [40, 41, 42], [43, 44, 45]]);
        // up: [
        // [37, 38, 39],
        // [40, 41, 42],
        // [43, 44, 45]],
        assert_eq!(cube.right, [[28, 29, 37], [31, 32, 38], [34, 35, 39]]);
        // right: [
        // [28, 29, 30],
        // [31, 32, 33],
        // [34, 35, 36]],
        assert_eq!(cube.down, [[46, 47, 48], [49, 50, 51], [36, 33, 30]]);
    }
    #[test]
    fn it_works_rot_left() {
        ...
        // [13, 14, 15],
        // [16, 17, 18]],
        assert_eq!(cube.up, [[18, 38, 39], [15, 41, 42], [12, 44, 45]]);
        // front: [
        // [1, 2, 3],
        // [4, 5, 6],
        // [7, 8, 9]],
        assert_eq!(cube.down, [[1, 47, 48], [4, 50, 51], [7, 53, 54]]);
        // up: [
        // [37, 38, 39],
        // [40, 41, 42],
        // [43, 44, 45]],
        assert_eq!(cube.front, [[37, 2, 3], [40, 5, 6], [43, 8, 9]]);
        // down: [
        // [46, 47, 48],
        // [49, 50, 51],
        // [52, 53, 54]],
        assert_eq!(cube.back, [[10, 11, 52], [13, 14, 49], [16, 17, 46]]);
    }
    ...
    fn it_works_rot_left_rev() {
        ...
        // [4, 5, 6],
        // [7, 8, 9]],
        assert_eq!(cube.up, [[1, 38, 39], [4, 41, 42], [7, 44, 45]]);
        // back: [
        // [10, 11, 12],
        // [13, 14, 15],
        // [16, 17, 18]],
        assert_eq!(cube.down, [[18, 47, 48], [15, 50, 51], [12, 53, 54]]);
        // down: [
        // [46, 47, 48],
        // [49, 50, 51],
        // [52, 53, 54]],
        assert_eq!(cube.front, [[46, 2, 3], [49, 5, 6], [52, 8, 9]]);
        // up: [
        // [37, 38, 39],
        // [40, 41, 42],
        // [43, 44, 45]],
        assert_eq!(cube.back, [[10, 11, 43], [13, 14, 40], [16, 17, 37]]);
    }
    #[test]
    fn it_works_rot_right() {
        ...
        // [4, 5, 6],
        // [7, 8, 9]],
        assert_eq!(cube.up, [[37, 38, 3], [40, 41, 6], [43, 44, 9]]);
        // back: [
        // [10, 11, 12],
        // [13, 14, 15],
        // [16, 17, 18]],
        assert_eq!(cube.down, [[46, 47, 16], [49, 50, 13], [52, 53, 10]]);
        // down: [
        // [46, 47, 48],
        // [49, 50, 51],
        // [52, 53, 54]],
        assert_eq!(cube.front, [[1, 2, 48], [4, 5, 51], [7, 8, 54]]);
        // up: [
        // [37, 38, 39],
        // [40, 41, 42],
        // [43, 44, 45]],
        assert_eq!(cube.back, [[45, 11, 12], [42, 14, 15], [39, 17, 18]]);
    }
    #[test]
    fn it_works_rot_right_rev() {
        ...
        // [13, 14, 15],
        // [16, 17, 18]],
        assert_eq!(cube.up, [[37, 38, 16], [40, 41, 13], [43, 44, 10]]);
        // front: [
        // [1, 2, 3],
        // [4, 5, 6],
        // [7, 8, 9]],
        assert_eq!(cube.down, [[46, 47, 3], [49, 50, 6], [52, 53, 9]]);
        // up: [
        // [37, 38, 39],
        // [40, 41, 42],
        // [43, 44, 45]],
        assert_eq!(cube.front, [[1, 2, 39], [4, 5, 42], [7, 8, 45]]);
        // down: [
        // [46, 47, 48],
        // [49, 50, 51],
        // [52, 53, 54]],
        assert_eq!(cube.back, [[54, 11, 12], [51, 14, 15], [48, 17, 18]]);
    }
    #[test]
    fn it_works_rot_up() {
        let mut cube = Cube::new();
        ...
        // [31, 32, 33],
        // [34, 35, 36]],
        assert_eq!(cube.front, [[28, 29, 30], [4, 5, 6], [7, 8, 9]]);
        // left: [
        // [19, 20, 21],
        // [22, 23, 24],
        // [25, 26, 27]],
        assert_eq!(cube.back, [[19, 20, 21], [13, 14, 15], [16, 17, 18]]);
        // front: [
        // [1, 2, 3],
        // [4, 5, 6],
        // [7, 8, 9]],
        assert_eq!(cube.left, [[1, 2, 3], [22, 23, 24], [25, 26, 27]]);
        // back: [
        // [10, 11, 12],
        // [13, 14, 15],
        // [16, 17, 18]],
        assert_eq!(cube.right, [[10, 11, 12], [31, 32, 33], [34, 35, 36]]);
    }
    #[test]
    fn it_works_rot_up_rev() {
        ...
        // [22, 23, 24],
        // [25, 26, 27]],
        assert_eq!(cube.front, [[19, 20, 21], [4, 5, 6], [7, 8, 9]]);
        // right: [
        // [28, 29, 30],
        // [31, 32, 33],
        // [34, 35, 36]],
        assert_eq!(cube.back, [[28, 29, 30], [13, 14, 15], [16, 17, 18]]);
        // back: [
        // [10, 11, 12],
        // [13, 14, 15],
        // [16, 17, 18]],
        assert_eq!(cube.left, [[10, 11, 12], [22, 23, 24], [25, 26, 27]]);
        // front: [
        // [1, 2, 3],
        // [4, 5, 6],
        // [7, 8, 9]],
        assert_eq!(cube.right, [[1, 2, 3], [31, 32, 33], [34, 35, 36]]);
    }
    #[test]
    fn it_works_rot_down() {
        ...
        // [22, 23, 24],
        // [25, 26, 27]],
        assert_eq!(cube.front, [[1, 2, 3], [4, 5, 6], [25, 26, 27]]);
        // right: [
        // [28, 29, 30],
        // [31, 32, 33],
        // [34, 35, 36]],
        assert_eq!(cube.back, [[10, 11, 12], [13, 14, 15], [34, 35, 36]]);
        // back: [
        // [10, 11, 12],
        // [13, 14, 15],
        // [16, 17, 18]],
        assert_eq!(cube.left, [[19, 20, 21], [22, 23, 24], [16, 17, 18]]);
        // front: [
        // [1, 2, 3],
        // [4, 5, 6],
        // [7, 8, 9]],
        assert_eq!(cube.right, [[28, 29, 30], [31, 32, 33], [7, 8, 9]]);
    }
    #[test]
    fn it_works_rot_down_rev() {
        ...
        // [31, 32, 33],
        // [34, 35, 36]],
        assert_eq!(cube.front, [[1, 2, 3], [4, 5, 6], [34, 35, 36]]);
        // left: [
        // [19, 20, 21],
        // [22, 23, 24],
        // [25, 26, 27]],
        assert_eq!(cube.back, [[10, 11, 12], [13, 14, 15], [25, 26, 27]]);
        // front: [
        // [1, 2, 3],
        // [4, 5, 6],
        // [7, 8, 9]],
        assert_eq!(cube.left, [[19, 20, 21], [22, 23, 24], [7, 8, 9]]);
        // back: [
        // [10, 11, 12],
        // [13, 14, 15],
        // [16, 17, 18]],
        assert_eq!(cube.right, [[28, 29, 30], [31, 32, 33], [16, 17, 18]]);
    }
    #[test]
